...
\pgfplotstabletypeset[begin table=\begin{longtable},
   ...
   ,columns/Time/.style={string type,column type=p{4cm}},
    columns/S1/.style={string type,column type=p{4cm}},
    columns/S2/.style={string type,column type=p{4cm}},
    columns/S3/.style={string type,column type=p{4cm}},
    columns/S4/.style={string type,column type=p{4cm}},
    columns/S5/.style={string type,column type=p{4cm}},
    ]{schedule.csv} 
\end{landscape}
